<?php
/**************************************************************************************************
* File Name        : v_evaluation_form_v2.php
...
?>
<script language="javascript" type="text/javascript" src="<?=base_url()?>assets/js/evaluation/markings_v2.js"></script>
<?php
	$titleType = "";
...
<legend><h3>Pentaksiran Berterusan <?=$titleType ?></h3></legend>
<center>
<input type="hidden" id="ksmid" value="" name="ksmid" />

<form id="frm_marking" action="<?= site_url('examination/markings_v2/select_configuration')?>" method="post" >
		...
		?>
					<td align="center">
						<input type="text" readonly="readonly" name="jumlah<?=$row->stu_id?><?=$sbc->assgmnt_id?>" 
							id="jumlah<?=$row->stu_id?><?=$sbc->assgmnt_id?>" style="width: 100px;" value="<?=ceil($row->markah[$k]) ?>">
					</td>
		<?php
				//}
			}
...
<div class="modal hide fade" id="myModal" style="width:66%; left:40%;">
    ...
    <div class="modal-body" >
        <form id="formConfig" name="formConfig" style="position:relative;" 
        	action="<?=site_url("examination/markings_v2/save_configurations")?>" method="post">
...
<div class="modal hide fade" id="assgmnpop" style="width:80%; left:32%;">
    <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" 
		    aria-hidden="true">&nbsp;&times;&nbsp;</button>
...
<form id="loadStudent" name="loadStudent" action="<?=site_url("examination/markings_v2/load_configurations")?>" method="post">
