...
<script language="javascript" type="text/javascript" src="<?=base_url()?>assets/js/evaluation/markings_v3.js"></script>
<script language="javascript" type="text/javascript" src="<?=base_url()?>assets/js/localforage.min.js"></script>
<script language="javascript" type="text/javascript" src="<?=base_url()?>assets/js/offlineFunction.js"></script>
...
<legend><h3>Pentaksiran Berterusan <?=$titleType ?>
			<div style="float:right; width:249px;">
				<a class="btn btn-warning" type="application/pdf" href="<?=base_url()?>assets/pdffile/ManualPentaksiran.pdf" target="_blank"><span>Manual Pentaksiran Berterusan</span></a>
	        </div>
	    </h3>
</legend>
<center>
...
<form id="frm_marking" action="<?= site_url('examination/markings_v3/select_configuration')?>" method="post" >
    ...
    <tr>
        ...
        <td height="35">
        	<div align="left">
          	<?php
            	...
            	if(isset($idParent) && ("" == $idParent->la_id_parent || NULL == $idParent->la_id_parent|| 0==$idParent->la_id_parent))
				{					
          ?>
		...
		<?php
				...
				else 
				{
					...
					?>
					<button id="btn_config_markP" disabled="disabled" class="btn btn-info" type="button">
	                    <span>Penetapan Markah</span>
	           </button><br/>
	                <span style="color:red"><i>Penetapan markah hanya boleh dibuat Ketua Pensyarah sahaja</i></span>
		<?php
...
<table id="tableOffline" width="100%" align="center" cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered">
	<thead>
		<tr style="background-color: white;">
			...
			<th align="left" width="10%">KELAS</th>
...
?>
<!-- <button id="enableOffline" class="btn btn-success" style="margin-bottom:-30px;">Enable Offline</button> -->
<button type="button" id="enableOffline" class="btn btn-success" data-loading-text="Loading..." style="margin-bottom:-30px;">Offline Mode</button>
<table id="tblStudent" width="100%" align="center"  
	cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered"
	style="float:left;">
	<thead>
	<tr style="background-color: white;">
		<th class="headTable" width="2%">BIL</th>
		<th class="headTable" align="left" width="15%">NAMA MURID</th>
		<th class="headTable" align="left" width="5%">ANGKA GILIRAN</th>
		<?php
		$j = 0;
		foreach($subjekconfigur as $sbc)
		{
			...
			if(strtoupper($assignment) == "TEORI")
			{
				...
				//{
		?>
					<th class="headTable" align="center" width="4%" title="<?=$sbc->assgmnt_id?>">
		...
		?>
		<th class="headTable" width="5%">JUMLAH / <?=$j?></th>
	</tr>
	</thead>
	<tbody>
	<?php
	...
	<tr>
		...
		<td align="left"><?=ucwords(strtolower($row->stu_name))?></td>
...
{
	?>
	<h5><strong>Tiada pelajar dipaparkan.</strong></h5>
	<?php
}
?>
...
<div class="modal hide fade" id="myModal" style="width:66%; left:40%;">
    ...
    <div class="modal-body" >
        <form id="formConfig" name="formConfig" style="position:relative;" 
        	action="<?=site_url("examination/markings_v3/save_configurations")?>" method="post">
			...
			<input type="hidden" id="tempKAt2" name="tempKAt2" value="" />
			<input type="hidden" id="kelas" name="kelas" value="" />
			<!-- temp utk function AK -->
            ...
            <div class="pull-right">            	
            	<button id="btnSaveConfig" type="button" name="btnSaveConfig" 
...
<div class="modal hide fade" id="assgmnpop" style="width:80%; left:32%; z-index:999999;">
    <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" 
		    aria-hidden="true">&nbsp;&times;&nbsp;</button>
...
<form id="loadStudent" name="loadStudent" action="<?=site_url("examination/markings_v3/load_configurations")?>" method="post">
