<legend>Senarai Pengarah Kolej</legend>
...
check = false;
	...
	$this -> table -> set_heading('id','Nama Pengguna', 'Katanama', 'Email', 'Tarikh Daftar', 'Tarikh Log Masuk', 'Status', 'No Telefon', 'Kolej', 'Jawatan', 'Tindakan');
