...
<form id="frm_pusat" action="<?= site_url('report/result/attendance_exam_print')?>" method="post" target="_blank">
<table class="breadcrumb border" width="100%" align="center">
    ...
    <tr>
        ...
        <td height="35">
            <div align="left">
                <input class="btn btn-info" type="submit" name="btn_papar" value="Papar Jadual Kedatangan">
            </div>
        </td>
    </tr>
    <tr>
