...
<form id="frm_pusat" action="<?= site_url('report/result/resultRoster')?>" method="post" target="_blank">
<table class="breadcrumb border" width="100%" align="center">
    ...
    <tr>
     ...
     <tr>
        ...
        <td height="35">
            <div align="left">
                <select id="statusID" name="statusID" style="width:270px;" class="validate[required]">
                    <option value="">-- Sila Pilih --</option>
    ...
    <tr>
        ...
        <td height="35">
            <div align="left">
                <input class="btn btn-info" type="submit" name="btn_papar" value="Papar Roster">
            </div>
        </td>
    </tr>
    <tr>
