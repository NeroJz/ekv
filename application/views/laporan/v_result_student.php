...
<legend><h3>Slip Keputusan </h3></legend>
<center>

<form id="frm_pusat" action="<?= site_url('report/result/print_result_student')?>" method="post" target="_blank">
...
?> -->
    ...
    <tr>
        ...
        <td height="35">
        	<div align="left">
          		<input class="btn btn-info" type="submit" name="btn_papar" value="Papar Slip Keputusan">
        	</div>
        </td>
    </tr>
    <tr>
