...
<legend><h3>Kenyataan Kemasukan Penilaian Akhir</h3></legend>
<center>

<form id="frm_pusat" action="<?= site_url('sup/student_ticket/papar_ticket')?>" method="post" target="_blank">
<table class="breadcrumb border" width="100%" align="center">
    ...
    <tr>
        ...
        <td height="35">
            <div align="left">
                <input class="btn btn-info" type="submit" name="btn_papar" value="Papar Slip">
            </div>
        </td>
    </tr>
    <tr>
