    ...
    <h2>Fail Induk Keputusan</h2>
          ...
          <thead>
            <tr>
                ...
                <th class="desc"  style="padding-right: 200px;"  align="center">NAMA  MURID</th>
			...
			$keyk=	count($stuk->moduletaken);
                ...
                for ($i=1; $i<=($uniqcodesub[0]); $i++){
                		?>
                <th class="desc"  align="center">KOD_MP<?=$i?></th>
		      	<th class="desc"  id="tdright" align="center">NAMA_MP<?=$i?></th>
                <th class="desc"  id="tdright" align="center">JK_MP<?=$i?></th>
                <th class="desc"  id="tdright" align="center">GRED_MP<?=$i?></th>
                <th class="desc"  id="tdright" align="center">NM_MP<?=$i?></th>
                <th class="desc"  id="tdright" align="center">MK_MP<?=$i?></th>
                <th class="desc"  id="tdright" align="center">STATUS_MP<?=$i?></th>
                <?php } ?>
...
?>
		...
		<td class="desc"  id="tdright" align="center"><?=$stu->pngkk?></th>
