<?php
session_start();
class Combine_marks extends MY_Controller {
	...
	function index() 
	{
        ...
        $data['output'] = $this->load->view('marking/v_combine', $data, true);
	...
	function view_list()
	{
		...
		$data['kursus'] = $this->m_kursus->kursus_list();
		$data['subjek_akademik'] = $this->m_pelajar->subjek_akademik_list($tmpKursus, $semester);
		$data['pelajar_akademik'] = $this->m_pelajar->pelajar_akademik_list($tmpKursus, $semester, $year, strtoupper($pengurusan));
